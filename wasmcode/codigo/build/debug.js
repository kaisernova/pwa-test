async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    validarCedula(digitosArray, veces) {
      // assembly/index/validarCedula(~lib/array/Array<i32>, i32) => i32
      digitosArray = __lowerArray((pointer, value) => { new Int32Array(memory.buffer)[pointer >>> 2] = value; }, 3, 2, digitosArray) || __notnull();
      return exports.validarCedula(digitosArray, veces);
    },
  }, exports);
